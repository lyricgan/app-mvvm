...
public class Repository extends BaseModel<RealmRepository> {
    public long id;
    public String name;
    ...
    public RealmRepository transformToRealm() {
        ...
        realmRepo.setDescription(description);
        realmRepo.setForks(forks);
        realmRepo.setWatchers(watchers);
        realmRepo.setStars(stars);
        realmRepo.setLanguage(language);
        realmRepo.setHomepage(homepage);
        realmRepo.setOwner(owner.transformToRealm());
        realmRepo.setFork(fork);
        return realmRepo;
    }
    ...
    public BaseModel transformFromRealm(RealmRepository realm) {
        ...
        repo.description = realm.getDescription();
        repo.forks = realm.getForks();
        repo.watchers = realm.getWatchers();
        repo.stars = realm.getStars();
        repo.language = realm.getLanguage();
